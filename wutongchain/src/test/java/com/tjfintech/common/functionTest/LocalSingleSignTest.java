...
public class LocalSingleSignTest {
    ...
    public void TC024_SoloProgress_LocalSign() throws Exception {
        ...
        multiSignTest.multiSignTransfer_LocalSign(IMPPUTIONADD, PUBKEY4, transferData, transferList2, PRIKEY4PATH); //多账号转账
    ...
    public void TC024_SoloProgress_LocalSign_PWD() throws Exception {
        ...
        multiSignTest.multiSignTransfer_LocalSign(IMPPUTIONADD, PUBKEY4, transferData, transferList, PRIKEY4PATH); //多账号转账
