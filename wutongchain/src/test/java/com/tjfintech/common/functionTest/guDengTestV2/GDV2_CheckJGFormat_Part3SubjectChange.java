...
@Slf4j
public class GDV2_CheckJGFormat_Part3SubjectChange {
...
//        gdBefore.initRegulationData();
    ...
    public void TC06_shareIssue() throws Exception {
        ...
        gdEquityCode = CNKey + "Token_" + Random(12);
...
//        uf.calJGDataEachHeight();
    ...
    public void shareTransfer_AllOut()throws Exception{
        ...
        assertEquals("检查无主体报送",false,uriStoreData.contains(gdCompanyID));
    ...
    public void shareTransfer_DiffMoneyType()throws Exception{
        ...
        fromNow.put("register_registration_type",2);       //更新对比的登记类型
        toNow.put("register_registration_type",3);       //更新对比的登记类型
        fromNow.put("register_currency","860");       //更新对比的登记币种
        toNow.put("register_currency","861");       //更新对比的登记币种
