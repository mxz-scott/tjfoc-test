...
public class BlockSyncTest_DockerImageFlag_WithContract {
    ...
    public void TC981_OnePeerAll()throws Exception{
        ...
        assertThat(multiSign.delCollAddrs(ADDRESS1), containsString("200"));
        assertThat(multiSign.delIssueaddrs(ADDRESS6), containsString("200"));
        assertThat(multiSign.delIssueaddrs(ADDRESS1), containsString("200"));
    ...
    public void StoreUTXONoCheck()throws Exception{
        ...
        assertThat(multiSign.delCollAddrs(ADDRESS1), containsString("200"));
        assertThat(multiSign.delIssueaddrs(ADDRESS6), containsString("200"));
        assertThat(multiSign.delIssueaddrs(PRIKEY1,ADDRESS1), containsString("200"));
