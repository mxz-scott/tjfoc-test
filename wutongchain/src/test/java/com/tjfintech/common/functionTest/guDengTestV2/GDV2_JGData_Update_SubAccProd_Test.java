...
//    @Test
    public void TC20_partUpdateSubjectInfo_Personal()throws Exception {
        ...
        Map mapTest = (Map) com.alibaba.fastjson.JSON.parse(JSONObject.fromObject(response).getString("data"));
        Map mapR = new HashMap();
        String key = "subject_object_id";
        mapR.put(key, mapTest.get(key));
        key = "subject_type";
        mapR.put(key, mapTest.get(key));
...
//        mapTemp.put("account_object_information_type",1);
        ...
        Map mapR = new HashMap();
        String key = "account_object_id";
        mapR.put(key, mapSHAccGet2.get(key));
        key = "account_number";
        mapR.put(key, mapSHAccGet2.get(key));
...
//        mapTemp.put("account_object_information_type",1);
        ...
        Map mapR = new HashMap();
        String key = "account_object_id";
        mapR.put(key, mapFundAccGet2.get(key));
        key = "account_number";
        mapR.put(key, mapFundAccGet2.get(key));
        key = "account_opening_date";
        mapR.put(key, mapFundAccGet2.get(key));
