...
//    }
    ...
    public Map init01PersonalSubjectInfo() {
        ...
        //主体信息 机构主体信息 企业基本信息
        mapTemp.put("subject_company_name", "公司");
        mapTemp.put("subject_company_english_name", "gongsi");
        mapTemp.put("subject_company_short_name", "公司简称CHARACTER");
        mapTemp.put("subject_company_short_english_name", "英文简称CHARACTER");
        mapTemp.put("subject_organization_nature", 1);
        mapTemp.put("subject_legal_type", 2);
        ...
        mapTemp.put("subject_district", "籍贯CHARACTER");
        mapTemp.put("subject_office_address", "省份CHARACTER");
        mapTemp.put("subject_contact_address", "城市CHARACTER");
        mapTemp.put("subject_contact_number", "投资经历CHARACTER");
        mapTemp.put("subject_enterprise_fax", "省份CHARACTER");
        mapTemp.put("subject_postal_code", "城市CHARACTER");
        mapTemp.put("subject_internet_address", "投资经历CHARACTER");
        mapTemp.put("subject_mail_box", "籍贯CHARACTER");
        mapTemp.put("subject_association_articles", getListFileObj());
        mapTemp.put("subject_regulator", "城市CHARACTER");
        mapTemp.put("subject_shareholders_number", 1);
        mapTemp.put("subject_taxpayer_id_number", "投资经历CHARACTER");
        mapTemp.put("subject_invoice_bank", "省份CHARACTER");
        mapTemp.put("subject_invoice_account_number", "城市CHARACTER");
        mapTemp.put("subject_invoice_address", "投资经历CHARACTER");
        mapTemp.put("subject_invoice_telephone_number", "籍贯CHARACTER");
        mapTemp.put("subject_approval_time", time1);
        mapTemp.put("subject_insured_number", 1);
        mapTemp.put("subject_company_status", 1);
        mapTemp.put("subject_company_status_deregistration", "投资经历CHARACTER");
        mapTemp.put("subject_company_status_deregistration_date", date1);
        mapTemp.put("subject_company_status_windingup", "城市CHARACTER");
        mapTemp.put("subject_company_status_windingup_date", date1);
        mapTemp.put("subject_name_used_before", "籍贯CHARACTER");
        mapTemp.put("subject_personnel_size", "人员规模");

        List<Map> listLMI = new ArrayList<>();
        Map mapLMI = new HashMap();
        mapLMI.put("subject_keypersonnel_name", "姓名0001");
        ...
        mapLMI.put("subject_keypersonnel_appointment_end", date1);
        mapLMI.put("subject_keypersonnel_nationality", "国籍0001");
        mapLMI.put("subject_document_type", 1);
        mapLMI.put("subject_keypersonnel_id", "证件号码0001");
        mapLMI.put("subject_keypersonnel_address", "证件地址");
        mapLMI.put("subject_keypersonnel_shareholding_ratio", 600000);
        mapLMI.put("subject_keypersonnel_shareholding", 600000);
        mapLMI.put("subject_keypersonnel_contact", "联系方式0001");
        listLMI.add(mapLMI);
        mapTemp.put("leading_member_information", listLMI);
