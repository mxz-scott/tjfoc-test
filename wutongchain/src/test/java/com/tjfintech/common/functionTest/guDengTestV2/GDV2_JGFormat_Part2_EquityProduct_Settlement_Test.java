...
//        toNow.put("register_transaction_ref",txRpObjId);
        ...
        String query = gd.GDGetEnterpriseShareInfo(gdEquityCode);
        assertEquals(false, query.contains(toAddr));
        ...
        assertEquals(true, query.contains(toAddr));
...
//        toNow.put("register_available_balance",transferAmount);
        ...
        //校验监管报送的顺序（"subject","account","product","transactionreport","registration","settlement","infodisclosure）
        JSONArray jsonArray = JSONArray.fromObject(uriInfo.get("storeData"));
        assertEquals(chkSubURI, JSONObject.fromObject(jsonArray.get(0)).getString("uri"));
        assertEquals(chkTxRpURI, JSONObject.fromObject(jsonArray.get(1)).getString("uri"));
        assertThat(JSONObject.fromObject(jsonArray.get(2)).getString("uri"),
                anyOf(containsString(chkRegURI1), containsString(chkRegURI2)));
        assertThat(JSONObject.fromObject(jsonArray.get(3)).getString("uri"),
                anyOf(containsString(chkRegURI1), containsString(chkRegURI2)));
...
//        BigDecimal totalShares = new BigDecimal(JSONObject.fromObject(query2).getJSONObject("data").getString("subject_total_share_capital"));
        ...
        //校验监管报送的顺序（"subject","account","product","transactionreport","registration","settlement","infodisclosure）
        JSONArray jsonArray = JSONArray.fromObject(uriInfo.get("storeData"));
        assertEquals(conJGFileName(gdCompanyID, "2"), JSONObject.fromObject(jsonArray.get(0)).getString("uri"));
        assertEquals(conJGFileName(gdEquityCode, "1"), JSONObject.fromObject(jsonArray.get(1)).getString("uri"));
        assertEquals(conJGFileName(txObjId, "0"), JSONObject.fromObject(jsonArray.get(2)).getString("uri"));
        assertThat(JSONObject.fromObject(jsonArray.get(3)).getString("uri"),
                anyOf(containsString(mapAddrRegObjId.get(gdAccount1 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount2 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount3 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount4 + "0").toString())));
        assertThat(JSONObject.fromObject(jsonArray.get(4)).getString("uri"),
                anyOf(containsString(mapAddrRegObjId.get(gdAccount1 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount2 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount3 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount4 + "0").toString())));
        assertThat(JSONObject.fromObject(jsonArray.get(5)).getString("uri"),
                anyOf(containsString(mapAddrRegObjId.get(gdAccount1 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount2 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount3 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount4 + "0").toString())));
        assertThat(JSONObject.fromObject(jsonArray.get(6)).getString("uri"),
                anyOf(containsString(mapAddrRegObjId.get(gdAccount1 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount2 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount3 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount4 + "0").toString())));
...
//        assertEquals(totalShares.add(new BigDecimal("4000")),totalShares2);
    ...
    public void TC1201_shareRecycleOneAcc() throws Exception {
        ...
        //校验监管报送的顺序（"subject","account","product","transactionreport","registration","settlement","infodisclosure）
        JSONArray jsonArray = JSONArray.fromObject(uriInfo.get("storeData"));
        assertEquals(conJGFileName(gdCompanyID, "3"), JSONObject.fromObject(jsonArray.get(0)).getString("uri"));
...
//        assertEquals(totalShares.subtract(new BigDecimal("100")),totalShares2);
    ...
    public void TC1202_shareRecycleMultiAcc() throws Exception {
        ...
        //校验监管报送的顺序（"subject","account","product","transactionreport","registration","settlement","infodisclosure）
        JSONArray jsonArray = JSONArray.fromObject(uriInfo.get("storeData"));
        assertEquals(conJGFileName(gdCompanyID, "4"), JSONObject.fromObject(jsonArray.get(0)).getString("uri"));
        assertThat(JSONObject.fromObject(jsonArray.get(1)).getString("uri"),
                anyOf(containsString(mapAddrRegObjId.get(gdAccount1 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount2 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount3 + "0").toString()),
                        containsString(mapAddrRegObjId.get(gdAccount4 + "0").toString())));
...
//        assertEquals(totalShares.subtract(new BigDecimal("400")),totalShares2);
    ...
    public void TC13_shareChangeBoard() throws Exception {
        ...
        Map uriInfo = gdCF.getJGURIStoreHash(txId, "supervision", 1);
        JSONArray jsonArray = JSONArray.fromObject(uriInfo.get("storeData"));
        assertEquals(conJGFileName(oldEquityCode, "2"), JSONObject.fromObject(jsonArray.get(0)).getString("uri"));
        assertEquals(conJGFileName(newEquityCode, "0"), JSONObject.fromObject(jsonArray.get(1)).getString("uri"));
        ...
        for (int k = 0; k < dataShareList.size(); k++) {
            ...
            //校验监管报送的顺序（"subject","account","product","transactionreport","registration","settlement","infodisclosure）
            assertThat(conJGFileName(tempObjId, "0"), anyOf(containsString(JSONObject.fromObject(jsonArray.get(2)).getString("uri")),
                    containsString(JSONObject.fromObject(jsonArray.get(3)).getString("uri")),
                    containsString(JSONObject.fromObject(jsonArray.get(4)).getString("uri")),
                    containsString(JSONObject.fromObject(jsonArray.get(5)).getString("uri")),
                    containsString(JSONObject.fromObject(jsonArray.get(6)).getString("uri")),
                    containsString(JSONObject.fromObject(jsonArray.get(7)).getString("uri"))));
