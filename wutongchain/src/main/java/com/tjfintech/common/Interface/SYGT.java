...
public interface SYGT {
    ...
    String SSAssetAuthorize(String assetID,String code,double expireStart,double expireEnd); //资产授权
    ...
    String SSSettingUpdate(String scene,String label); //更新使用场景和数据标签列表
